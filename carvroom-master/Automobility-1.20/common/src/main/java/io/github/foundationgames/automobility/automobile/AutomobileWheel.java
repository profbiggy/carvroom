...
public record AutomobileWheel(
    ...
    public static final AutomobileWheel STANDARD = REGISTRY.register(
            new AutomobileWheel(Automobility.rl("standard"), 1.05f, 0.25f, new WheelModel(3.5f, 4, Automobility.rl("textures/entity/automobile/wheel/standard.png"), Automobility.rl("wheel_standard")))
    );
    ...
    public static final AutomobileWheel CARRIAGE = REGISTRY.register(carriage("carriage", 0.25f));
    public static final AutomobileWheel PLATED = REGISTRY.register(carriage("plated", 0.25f));
    public static final AutomobileWheel STREET = REGISTRY.register(carriage("street", 0.25f));
    public static final AutomobileWheel GILDED = REGISTRY.register(carriage("gilded", 0.25f));
    public static final AutomobileWheel BEJEWELED = REGISTRY.register(carriage("bejeweled", 0.25f));

    private static AutomobileWheel carriage(String name, float grip) {
        return new AutomobileWheel(Automobility.rl(name), 1.05f, grip, new WheelModel(5f, 4f, Automobility.rl("textures/entity/automobile/wheel/"+name+".png"), Automobility.rl("wheel_carriage")));
    }
