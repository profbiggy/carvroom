...
public record AutomobileEngine(
    ...
    public static final AutomobileEngine STONE = REGISTRY.register(
            new AutomobileEngine(Automobility.rl("stone"), 0.95f, 0.85f,
    ...
    public static final AutomobileEngine IRON = REGISTRY.register(
            new AutomobileEngine(Automobility.rl("iron"), 0.95f, 0.85f,
    ...
    public static final AutomobileEngine COPPER = REGISTRY.register(
            new AutomobileEngine(Automobility.rl("copper"), 0.95f, 0.85f,
    ...
    public static final AutomobileEngine GOLD = REGISTRY.register(
            new AutomobileEngine(Automobility.rl("gold"), 0.95f, 0.85f,
    ...
    public static final AutomobileEngine DIAMOND = REGISTRY.register(
            new AutomobileEngine(Automobility.rl("diamond"), 0.95f, 0.85f,
                    ...
                    new EngineModel(
                            ...
                            new AutomobileEngine.ExhaustPos(5, 2.2f, -6f, 50, 0),  //bottom right
                            new AutomobileEngine.ExhaustPos(-5, 2.2f, -6f, 50, 0), //bottom left
                            new AutomobileEngine.ExhaustPos(6.6f, 8.4f, -3f, 40, 0), //top right
                            new AutomobileEngine.ExhaustPos(-6.6f, 8.4f, -3f, 40, 0) //top left
                    )
            )
    );
